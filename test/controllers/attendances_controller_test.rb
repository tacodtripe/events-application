...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { attendee: @attendance.attendee, event_to_attend: @attendance.event_to_attend } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { attendee: @attendance.attendee, event_to_attend: @attendance.event_to_attend } }
